...
bash /vagrant/generators/gen_nginx_conf.sh www.weakco.vlab 3004 > /etc/nginx/sites-enabled/www.weakco.vlab
bash /vagrant/generators/gen_nginx_conf.sh evilhacker.vlab 3007 > /etc/nginx/sites-enabled/evilhacker.vlab
bash /vagrant/generators/gen_nginx_conf.sh www.xn--wekco-hra.vlab 3007 > /etc/nginx/sites-enabled/www.xn--wekco-hra.vlab
